import 'bloc/profile_police_bloc.dart';
import 'models/profile_police_model.dart';
...
class ProfilePolicePage extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<ProfilePoliceBloc>(
        create: (context) => ProfilePoliceBloc(ProfilePoliceState(
            profilePoliceModelObj: ProfilePoliceModel(),
            language: PrefUtils().getLanguage(),
            isSelectedNotification: PrefUtils().getNotificationStatus()))
          ..add(ProfilePoliceInitialEvent()),
        child: ProfilePolicePage());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ProfilePoliceBloc, ProfilePoliceState>(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: Text(PrefUtils().getStation() + " Station",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Spacer(),
                                      BlocSelector<ProfilePoliceBloc,
                                              ProfilePoliceState, bool?>(
                                          selector: (state) =>
